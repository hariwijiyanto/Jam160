...
def main():
    ...
    try:
        ...
        # Gabungkan dengan kode utama jika diperlukan, atau gunakan langsung
    ...
    # Pilih kernel berdasarkan mode
    if args.kernel_mode == 'optimized':
        ...
        print("[*] Menggunakan kernel standard")
